...
let Contract = (_dec = NearBindgen({}), _dec2 = initialize(), _dec3 = call({}), _dec4 = call({}), _dec5 = call({}), _dec6 = call({}), _dec7 = view(), _dec8 = view(), _dec(_class = (_class2 = class Contract {
  tokens = new UnorderedMap("tkns");
  appliedProjects = new UnorderedMap("appprjct");
  constructor() {
    this.owner_id;
    this.tokens;
    this.start;
  ...
  init({}) {
    this.owner_id = predecessorAccountId();
  }
  mintToken({
    today
  }) {
...
}, (_applyDecoratedDescriptor(_class2.prototype, "init", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "init"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "mintToken", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "mintToken"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "addProject", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "addProject"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "applyforProject", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "applyforProject"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "viewappliedProjects", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "viewappliedProjects"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "viewStartdate", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "viewStartdate"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "viewRatings", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "viewRatings"), _class2.prototype)), _class2)) || _class);
function viewRatings() {
  ...
  const _result = _contract.viewRatings(_args);
...
function viewStartdate() {
  ...
  const _args = Contract._getArgs();
  const _result = _contract.viewStartdate(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Contract._serialize(_result, true));
}
function viewappliedProjects() {
  const _state = Contract._getState();
  if (!_state && Contract._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = Contract._getArgs();
  const _result = _contract.viewappliedProjects(_args);
...
function applyforProject() {
  ...
  const _args = Contract._getArgs();
  const _result = _contract.applyforProject(_args);
  Contract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Contract._serialize(_result, true));
}
function addProject() {
  ...
  const _args = Contract._getArgs();
  const _result = _contract.addProject(_args);
  Contract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Contract._serialize(_result, true));
}
function mintToken() {
  ...
  const _args = Contract._getArgs();
  const _result = _contract.mintToken(_args);
  Contract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Contract._serialize(_result, true));
}
function init() {
...
export { Contract, addProject, applyforProject, init, mintToken, viewRatings, viewStartdate, viewappliedProjects };
